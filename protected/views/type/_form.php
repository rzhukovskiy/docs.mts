<div class="contenttitle radiusbottom0">
    <h2 class="table"><span>Добавить вид ТС</span></h2>
</div>
<?php
/**
...
$form = $this->beginWidget('CActiveForm', array(
    'id' => 'action-form',
    'action' => array($model->isNewRecord ? Yii::app()->createUrl("/type/create") : Yii::app()->createUrl("/type/update", array("id" => $model->id))),
