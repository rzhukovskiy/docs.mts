...
?>
    <div class="row">
        <span class="field">
                ФОРМАТ ФАЙЛА ТОЛЬКО xls!!! (не xlsx). ПРОСТЫМ ИЗМЕНЕНИЕМ РАСШИРЕНИЯ ЭТО НЕ РЕШАЕТСЯ, ФАЙЛ НАДО ПЕРЕСОХРАНЯТЬ!!!<br/>
                Любое количество листов.<br/>
                ...
                В четвертом столбике можно указать надо ли дезинфицировать машину (0 или 1).<br/>
