...
?>
        <tr class="<?=$row%2 ? 'even' : 'odd'?>">
            ...
            <td style="width: 80px; text-align:center;" class="<?=$data->hasError("car") ? "error" : ""?>"><?=$data->number ? $data->number : "error"?></td>
            ...
            <?php } ?>
            <td style="width: 60px; text-align:center;" class="<?=$data->hasError("income") ? "error" : ""?>"><?=$data->getFormattedField('income')?></td>
