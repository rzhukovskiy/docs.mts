<div class="contenttitle radiusbottom0">
    <h2 class="table"><span><?=$model->isNewRecord ? 'Создать мойку' : 'Редактировать мойку'; ?></span></h2>
</div>
<?php
/**
...
$form = $this->beginWidget('CActiveForm', array(
        'id' => 'action-form',
        'action' => array($model->isNewRecord ? Yii::app()->createUrl("/carwash/create") : Yii::app()->createUrl("/carwash/update", array("id" => $model->id))),
...
<div class="row">
    <span class="field">
        <?=CHtml::submitButton($model->isNewRecord ? 'Создать мойку' : 'Сохранить', array('class' => 'submit radius2', 'style' => 'opacity: 1;')); ?>
    </span>
</div>
<?php $this->endWidget(); ?>
<!-- form -->
