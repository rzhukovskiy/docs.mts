<div class="contenttitle radiusbottom0">
    <h2 class="table"><span>Мойки</span></h2>
</div>
<?php
/**
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'header' => '',
            'updateButtonUrl' => 'Yii::app()->createUrl("/carwash/update", array("id" => $data->id))',
            'deleteButtonUrl' => 'Yii::app()->createUrl("/carwash/delete", array("id" => $data->id))',
            'buttons' => array(
                'update' => array(
                    'label' => '',
                    'imageUrl' => false,
